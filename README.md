...
*HTML 자료*를 내장하고 있다고 가정함. 형식은 LTDB Database([text](http://www.typologydb.org/wiki/))를 따름.
...
*   `src/ingest/graph/graph_ingest.py`: **Experimental**. 지식 그래프 구축용이며 현재 파이프라인에는 포함되지 않았습니다.
